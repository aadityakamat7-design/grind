  ...
  return (
    <div className="relative mx-auto w-[280px] sm:w-[300px]">
      ...
      <div className="relative rounded-[2.6rem] border border-white/15 bg-slate-900/90 backdrop-blur p-2.5 shadow-2xl shadow-blue-950/60">
        <div className="rounded-[2rem] bg-gradient-to-b from-slate-950 to-slate-900 overflow-hidden">
          ...
          <div className="px-4 pt-2 pb-6">
            <p className="text-sm font-bold text-slate-400">Nearby jobs</p>
              ...
              {JOBS.map((j, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-slate-400">{j.meta}</p>
                  </div>
      ...
      >
        ...
        <span className="text-sm font-bold text-white">Parent approved</span>
      </motion.div>
      <motion.div
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
      ...
      >
        ...
        <div>
          <p className="text-sm text-slate-300 leading-none">Paid securely</p>
      ...
      >
        ...
        <span className="text-sm font-bold text-white">4.9 · 32 reviews</span>
      </motion.div>
    </div>
  );
}