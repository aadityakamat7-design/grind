...
export default function ReferralCard({ profile }) {
  ...
  const copy = () => {
    navigator.clipboard.writeText(`Join me on Blockwork — trusted teen help in our neighborhood! Use my code ${code} when you sign up and we both get ${money(REFERRAL_REWARD)} credit: ${window.location.origin}`);
    setCopied(true);
