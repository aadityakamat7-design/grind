...
export default function StateRulesDisplay({ stateRules, teenName }) {
  ...
  return (
    <div className="bg-blue-50/60 border border-blue-200 rounded-2xl p-4 space-y-4">
      ...
      <div>
        <p className="text-sm font-bold text-blue-800 mb-1.5">Minimum age by job category</p>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="bg-white rounded-lg p-2.5 border border-blue-100">
          <div className="flex items-center gap-1 mb-1">
            ...
            <p className="text-sm font-bold text-slate-700">School day</p>
          </div>
          <p className="text-sm text-slate-600">{hourRules.maxDailyHoursSchoolDay}h/day max</p>
          <p className="text-sm text-slate-600">{hourRules.maxWeeklyHoursSchoolWeek}h/week max</p>
        </div>
        <div className="bg-white rounded-lg p-2.5 border border-blue-100">
          <div className="flex items-center gap-1 mb-1">
            <Calendar className="w-3 h-3 text-blue-500" />
            <p className="text-sm font-bold text-slate-700">Non-school day</p>
          </div>
          <p className="text-sm text-slate-600">{hourRules.maxDailyHoursNonSchoolDay}h/day max</p>
          <p className="text-sm text-slate-600">{hourRules.maxWeeklyHoursSummer}h/week (summer)</p>
        </div>
      </div>

      <div className="bg-white rounded-lg p-2.5 border border-blue-100">
        <p className="text-sm font-bold text-slate-700 mb-1">Permitted hours</p>
