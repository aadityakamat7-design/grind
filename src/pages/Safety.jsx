...
const PILLARS = [
  ...
  },
  {
    ...
    body: "Blockwork automatically enforces California child-labor hour limits at booking — daily and weekly caps that vary by the teen's age, plus prohibited time windows so no minor is scheduled to work too early, too late, or during school hours. A teen who has reached their weekly limit is shown as unavailable. The casual, irregular odd jobs offered on this platform are generally exempt from California's work-permit requirement under the state's odd-jobs exemption for irregular casual work in private homes, as described in the California DIR Child Labor Law Pamphlet (dir.ca.gov/dlse). Parents and teens remain responsible for confirming any requirements applicable to their situation — Blockwork does not determine permit eligibility. Hour limits, age restrictions, and hazardous-occupation rules still apply. Parents are responsible for monitoring their teen's total hours, including any work outside the platform. (Blockwork currently operates in California only.)",
  },
  {
    icon: Eye,
