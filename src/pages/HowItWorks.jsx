  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto px-4 py-12 lg:py-20 w-full">
        ...
        <div className="mt-8 bg-gradient-to-br from-primary/10 to-transparent rounded-2xl border border-border p-6 text-center">
          <h2 className="font-bold text-foreground">Ready to get started?</h2>
          <p className="text-sm text-muted-foreground mt-1 mb-4">It takes less than two minutes to join.</p>
