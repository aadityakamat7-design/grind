...
// Short scannable labels for display; fullLabel is the full legal text
// recorded in the ConsentRecord audit trail. Mirrors base44/shared/consentItems.ts.
export const CONSENT_ITEMS = [
  { key: "relationship", label: "I am this teen's parent or legal guardian.", fullLabel: "I confirm I am this teen's parent or legal guardian, and I authorize them to use Blockwork under my supervision." },
  { key: "booking_approval", label: "I approve every job before my teen accepts it.", fullLabel: "I understand I must approve or deny every booking request before it is confirmed, and that confirmed bookings cannot be auto-started without my teen's and the buyer's mutual confirmation." },
  { key: "labor_laws", label: "California hour limits and age rules apply, and Blockwork enforces them.", fullLabel: "I understand my teen must follow California's child-labor laws, including the hour limits, prohibited work hours, and category minimums shown above — and that Blockwork enforces these hour limits server-side. The casual, irregular odd jobs offered on this platform (light outdoor tasks and online tutoring) are generally exempt from California's work-permit requirement under the state's odd-jobs exemption for irregular casual work in private homes, as described in the California DIR Child Labor Law Pamphlet (dir.ca.gov/dlse). I understand that I remain responsible for confirming any permit requirements applicable to my teen's situation, and that Blockwork does not determine permit eligibility. Hour limits, age restrictions, and hazardous-occupation rules still apply and are enforced by the platform. I am responsible for monitoring my teen's overall work hours, including any work outside Blockwork." },
