...
// AUTHORITATIVE maintained table for the SERVER — values come from here, never
// generated at runtime. Mirrors src/lib/stateHourLimits.js (frontend); keep in
// sync. See that file for the population/verification instructions.
// ============================================================================
...
export const STATE_HOUR_LIMITS: Record<string, { "14_15": any; "16_17": any }> = {
